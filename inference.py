...
if __name__ == '__main__':
    ...
    parser.add_argument('--img_path',default="D:/RDD2020_data/RDD2020_data/JPEGImages/Adachi_20170906093835.jpg",help='Image path')
    parser.add_argument('--checkpoint',default="BEST_checkpoint_ssd300.pth.tar",help='Path for pretrained model')
